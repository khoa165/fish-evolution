...
public class MediumFish extends EatableFish {
  private int fishMovementX;
  private int fishMovementY;
  private int fishControl;
  private Random rand = new Random();
  private final static double power = 1.5;

  public MediumFish(String fileName, int x, int y, ArrayList<EatableFish> target) {
    super(fileName, x, y, target);
  }

  @Override
  public double getPower() {
    return MediumFish.power;
  }
